    ...
    <div class="modal-body">
        ...
        <div class="row mt-2">
            ...
            <div class="col-6 text-right">
                ...
                <button class="btn btn-success " wire:click="addSchedule" wire:attr="disabled">
                    <span class="spinner-border spinner-border-sm" wire:loading wire:target="addSchedule" role="status"
