                ...
                <table class="table m-0 table-centered dt-responsive nowrap w-100" id="tickets-table">
                    <thead>
                        <tr>
                            ...
                            <th>Role</th>
                            <th>Description</th>
                            <th class="hidden-sm text-right">Action</th>
                        </tr>
                    </thead>
...
<div id="users-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel"
    aria-hidden="true">
...
<script>
	...
	$("#tickets-table").DataTable({
        ...
        processing: true,
                serverSide: true,
                ajax: '{!! route('admin.manage-user.index') !!}',
